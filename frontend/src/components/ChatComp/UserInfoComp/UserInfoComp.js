...
const UserInfoComp = ({ picClass, profilePic, firstName, lastName, email, dropDownMenu, onclonClickHandler, ...props }) => {
    return (
        <div className='container-fluid py-1 bg-grey'>
            <div className='d-flex flex-row align-items-center'>
                ...
                <section className=' d-block ms-auto dropdown'>
                    ...
                    <UserInfoDropDownComp onClickHandler={onclonClickHandler} dropDownMenu={dropDownMenu} />
                </section>
            </div>
        </div>
    )
